...
function GetLocation()
	for i : number = 1,2 do
		for _,v in workspace.GameSettings.TextPollen:GetChildren() do
			for _, l in next, workspace.GameSettings.TextPollen:GetChildren() do
				if l ~= v then
...
function ray(VP : Vector3?)
	...
	ray.FilterDescendantsInstances = {game.Workspace.GameSettings.Fields}
...
Remotes.VisualNumberEvent.OnClientEvent:Connect(VisualEvent)
